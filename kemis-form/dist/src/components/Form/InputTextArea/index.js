...
const InputTextArea = ({ className, classNameLabel, name, label, rules, form, }) => {
    return (react_1.default.createElement("div", { className: 'mb-5 ' + (className !== undefined && className) }, form && (react_1.default.createElement(react_hook_form_1.Controller, { name: name, control: form.control, rules: rules, 
        ...
        render: (_a) => {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("label", { htmlFor: field.name, className: (0, utils_1.classNames)({ 'text-red-400 ': fieldState.error }) +
                        'block ' +
                        (classNameLabel !== undefined && classNameLabel) }, label),
                react_1.default.createElement(inputtextarea_1.InputTextarea, Object.assign({ id: field.name }, field, { className: "w-full", placeholder: label }))));
        } }))));
};
