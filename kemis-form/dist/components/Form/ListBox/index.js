...
const ListBox = ({ className, name, label, form, options, rules, optionGroupLabel, multiple, optionGroupChildren, optionGroupTemplate, listStyle, }) => {
    return (react_1.default.createElement("div", { className: "mb-5 " + (className !== undefined && className) }, form && (react_1.default.createElement(react_hook_form_1.Controller, { name: name, control: form.control, rules: rules, render: (_a) => {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(listbox_1.ListBox, Object.assign({ id: field.name, multiple: multiple, options: options, optionGroupLabel: optionGroupLabel, optionGroupChildren: optionGroupChildren, optionGroupTemplate: optionGroupTemplate, listStyle: listStyle || { maxHeight: "200px" }, className: (0, utils_1.classNames)({ "p-invalid ": fieldState.error }) + "w-full" }, field, { ref: ref }))));
        } }))));
};
