...
const InputNumber = ({ className, name, label, mode, currency, locale, form, rules, }) => {
    const [value, setValue] = (0, react_1.useState)(0);
    const InputStyles = styled_components_1.default.div `
    .p-inputtext,
    .p-component,
    .p-inputnumber-input {
      width: 100%;
  ...
  `;
    return (react_1.default.createElement("div", { className: "mb-5 " + (className !== undefined && className) }, form && (react_1.default.createElement(react_hook_form_1.Controller, { name: name, control: form.control, rules: rules, render: (_a) => {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(InputStyles, null,
                    react_1.default.createElement(inputnumber_1.InputNumber, { id: field.name, mode: mode || "currency", currency: currency || "BRL", locale: locale || "pt-BR", value: value ? value : field.value, 
                        // {...field}
                        ref: ref, onChange: (event) => field.onChange(event.value), onBlur: (event) => setValue(Number(event.target.value)) }))));
        } }))));
};
